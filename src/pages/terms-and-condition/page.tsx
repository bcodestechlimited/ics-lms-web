    ...
    <div>
      <div className="container mx-auto max-w-6xl px-4 py-8">
        ...
        <h1 className="text-4xl font-bold mb-4">
          ICS Sourcing Academy – Terms and Conditions
        </h1>
        ...
        <Card className="mb-6 border-0 shadow-none">
          <CardContent className="px-0">
            <p className="text-justify">
              Welcome to ICS Sourcing Academy, the official Learning Management
              System (LMS) developed and managed by the Learning and Development
              Strategic Business Unit (SBU) of ICS Outsourcing Limited. ICS
            ...
            <p className="mt-4 text-justify">
              By accessing or using ICS Sourcing Academy, you agree to abide by
              the following Terms and Conditions. Please read them carefully
              before using the platform. If you do not agree to these terms, you
        ...
        <Card className="mb-6 border-0 shadow-none">
          <CardContent className="px-0">
            ...
            <p className="mb-3 text-justify">
              <strong>“ICS Sourcing Academy” or “The Platform”:</strong> The LMS
              created and managed by the Learning and Development SBU of ICS
              Outsourcing Limited.
            </p>
            <p className="mb-3 text-justify">
              <strong>ICS Outsourcing Limited:</strong> The parent organization
              and owner of ICS Sourcing Academy.
            </p>
            <p className="mb-3 text-justify">
        ...
        <Card className="mb-6 border-0 shadow-none">
          <CardContent className="px-0">
            ...
            <p className="text-justify mb-2">
              ICS Sourcing Academy is intended to:
            </p>
            <ul className="list-disc list-inside text-justify mb-2">
              ...
              <li>
                ...
                created or licensed by ICS Outsourcing Limited.
              </li>
              <li>
        ...
        <Card className="mb-6 border-0 shadow-none">
          <CardContent className="px-0">
            ...
            <p className="text-justify mb-2">
              Access to ICS Sourcing Academy is open to:
            </p>
            <ul className="list-disc list-inside text-justify mb-2">
              <li>
                Internal users: Employees and staff of ICS Outsourcing Limited.
              </li>
              <li>
        ...
        <Card className="mb-6 border-0 shadow-none">
          <CardContent className="px-0">
            ...
            <p className="text-justify mb-2">
              You agree to use ICS Sourcing Academy:
            </p>
            <ul className="list-disc list-inside text-justify mb-2">
        ...
        <Card className="mb-6 border-0 shadow-none">
          <CardContent className="px-0">
            ...
            <p className="text-justify mb-2">
              All materials made available on ICS Sourcing Academy are the
              property of ICS Outsourcing Limited or are provided under license.
              This includes:
            </p>
            <ul className="list-disc list-inside text-justify mb-2">
              <li>
        ...
        <Card className="mb-6 border-0 shadow-none">
          <CardContent className="px-0">
            ...
            <p className="text-justify">
              Your privacy is important to us. By using ICS Sourcing Academy,
              you agree to the collection and use of your personal information
              in accordance with our Privacy Policy (link to be inserted). This
              includes:
            </p>
            <ul className="list-disc list-inside text-justify mb-2">
        ...
        <Card className="mb-6 border-0 shadow-none">
          <CardContent className="px-0">
            ...
            <p className="text-justify mb-2">
              ICS Sourcing Academy offers certificates for selected training
              programs. Issuance of certificates is subject to:
            </p>
            <ul className="list-disc list-inside text-justify mb-2">
            ...
            <p className="text-justify">
              Certificates are issued solely by ICS Outsourcing Limited and are
              valid for professional development purposes. They do not confer
              academic credit unless otherwise stated.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6 border-0 shadow-none">
          <CardContent className="px-0">
            ...
            <p className="text-justify">
              ICS Outsourcing Limited reserves the right to:
            </p>
            <ul className="list-disc list-inside text-justify mb-2">
              <li>
        ...
        <Card className="mb-6 border-0 shadow-none">
          <CardContent className="px-0">
            ...
            <p className="text-justify">
              While ICS Outsourcing Limited strives to ensure the LMS is
              continuously available and up to date:
            </p>
            <ul className="list-disc list-inside text-justify mb-2">
              <li>
        ...
        <Card className="mb-6 border-0 shadow-none">
          <CardContent className="px-0">
            ...
            <p className="text-justify mb-2">
              ICS Sourcing Academy is provided “as is” without warranties of any
              kind.
            </p>
            <p className="text-justify mb-2">
            ...
            <p className="text-justify">
              ICS Outsourcing Limited is not liable for any indirect,
        ...
        <Card className="mb-6 border-0 shadow-none">
          <CardContent className="px-0">
            ...
            <p className="text-justify">
              For support, questions, or concerns related to ICS Sourcing
              Academy, please contact:
              <br />
              ICS Outsourcing Limited – Learning and Development SBU
              <br />
              Email:{" "}
              <a
